...
-- Multi-track URLs
local tracksURLs = {
    ["BC - 1"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/daun1.json",
    ["CP 1 - CP 2"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/daun2.json",
    ["CP 2 - CP 3"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/daun3.json",
    ["CP 3 - CP 4"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/daun4.json",
    ["CP 4 - SUMMIT"] = "https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/daun5.json",
}
...
-- Kalau ada arah valid, update lastFlatDir
if direction.Magnitude > 0.1 then
    resumeData.lastFlatDir = direction.Unit
end

-- Kalau lagi naik/curam, paksa tetap ngikut arah horizontal track
local lookDir = resumeData.lastFlatDir
if math.abs(deltaY) > 5 then
    if direction.Magnitude > 0.1 then
        lookDir = direction.Unit
    end
end

-- Lock orientasi ke arah track
-- Lock tapi tetap smooth
local blend = 0.05 -- makin besar makin kaku, makin kecil makin smooth
...
-- Lock orientasi ke arah track
-- Lock tapi tetap smooth
local blend = 0.20 -- makin besar makin kaku, makin kecil makin smooth
